    ...
    <div class="mt-4 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <a href="{{ route('admin.site-settings.edit') }}"
           class="rounded border border-gray-200 bg-white p-5 hover:border-gray-400">
            ...
            <p class="mt-1 text-sm text-gray-600">メディア名・ロゴ・テーマ・機能のオンオフ</p>
        </a>

        <a href="{{ route('admin.masters.home') }}"
           class="rounded border border-gray-200 bg-white p-5 hover:border-gray-400">
            <p class="font-semibold">マスタ管理</p>
            <p class="mt-1 text-sm text-gray-600">資格・施設形態・職種などの有効/無効と並び順</p>
        </a>

        <a href="{{ route('admin.audit-logs.index') }}"
           class="rounded border border-gray-200 bg-white p-5 hover:border-gray-400">
            <p class="font-semibold">監査ログ</p>
            <p class="mt-1 text-sm text-gray-600">操作者・期間・対象で絞り込んで確認</p>
        </a>
    </div>
@endsection
